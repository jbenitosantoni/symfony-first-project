 ...
 */
final class Version20200620151518 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedidos ADD fecha_enviado DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedidos DROP fecha_enviado');
    }
}
